...
Questo progetto è basato su [rpgm2renpy](https://github.com/selectivepaperclip/rpgm2renpy) di **selectivepaperclip**, da cui è partita la logica di conversione RPG Maker MV/MZ → Ren'Py.
