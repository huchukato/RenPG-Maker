...
define gui.accent_color = '#7ab8e0'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#8a9bb0'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#9aabbf'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#a8d4f0'
...
define gui.insensitive_color = '#8a9bb07f'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#082850'
define gui.hover_muted_color = '#106090'
...
define gui.text_font = "fonts/ArchivoNarrow-Regular.ttf"

## The font used for character names.
define gui.name_text_font = "fonts/Bitter-Black.ttf"
...
define gui.choice_button_text_idle_color = '#8a9bb0'
define gui.choice_button_text_hover_color = "#ffffff"
define gui.choice_button_text_insensitive_color = '#8a9bb07f'
